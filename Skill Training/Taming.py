...
# Set your skill cap
taming_cap = 100  # SkillCap('Animal Taming')
...
animals = {
    ...
    'mammoth': Animal('mammoth', 0x151, 0x0000, 70, 80),
...
def train_animal_taming():
    ...
    while not Dead('self') and Skill('Animal Tamin') < taming_cap:
        # Cast heal
